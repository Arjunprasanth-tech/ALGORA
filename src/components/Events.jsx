...
const ALL_EVENTS = [
  { id:'ai-app',  cat:'COLLEGE', num:'01', icon:'🤖', name:'AI APP DEVELOPMENT', desc:'Build intelligent applications. Solve real-world problems. Shape the future with AI-powered web solutions.', tag:'MAIN EVENT' },
  ...
  { id:'reel',    cat:'COLLEGE', num:'03', icon:'🎬', name:'REEL EDITING',          desc:'Edit your creativity. Tell your story in 60 seconds flat — every cut, frame, and beat counts.', tag:'COLLEGE'   },
